...
if __name__ == "__main__":
    ...
    for map_descriptor in map_descriptors:
        ...
        print("Map: {}".format(map_parser.name))
        for room_pointer in map_parser.room_pointers:
            ...
            if room == None:
                continue
            print(room.label, room.address)
            
            #print("    Objects: {}".format(room.animation_id_constant()))
        
        #    if room.label == "Overworld92":
        #        print("  Room: {} at 0x{:X}".format(room.label, room.address))
        #        print("    Animation ID: {}".format(room.animation_id_constant()))
        #        print("    Template ID: {}".format(room.template_id_constant()))
        #        print("    Floor Tile: {}".format(room.floor_tile))
        #        print("    Objects: {}".format(room.objects))
            #print()
        #print()
